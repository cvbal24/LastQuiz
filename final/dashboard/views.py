...
class RiderDashboardView(LoginRequiredMixin, TemplateView):
    template_name = "dashboard/rider_dashboard.html"
...
def rider_dashboard(request):
    # Redirect users who are not riders
    ...
    # Example data (replace with your actual queries)
    active_rides_count = 5
    completed_rides_count = 12
    earnings = 2450.75
    recent_rides = [
        {"id": 1, "date": "Oct 20, 2025", "status": "Completed", "fare": 120.00},
        {"id": 2, "date": "Oct 22, 2025", "status": "Ongoing", "fare": 95.00},
    ]
